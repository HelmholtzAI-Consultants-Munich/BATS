.. BATS documentation master file, created by
...
.. image:: https://github.com/HelmholtzAI-Consultants-Munich/BATS/actions/workflows/test.yml/badge.svg?event=push
   :alt: tests

.. image:: https://codecov.io/gh/HelmholtzAI-Consultants-Munich/BATS/branch/main/graph/badge.svg
   :target: https://codecov.io/gh/HelmholtzAI-Consultants-Munich/BATS
...
To install and start the server side follow the instructions described in :ref:`BATS Server`.
To run the client GUI follow the instructions described in :ref:`BATS Client`
...
- RGB and RGBA images are accepted, however they will be converted to grayscale after read into BATS. The dims can be [C, H, W] or [H, W, C]
...
.. toctree::
   ...
   bats_client_installation
   bats_server_installation
   bats_server
   bats_client
