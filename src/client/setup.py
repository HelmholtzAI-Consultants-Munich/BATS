...
class PostInstallCommand(install):
    ...
    def _download_sam_models(self):
        ...
        try:
            from bats_client.utils.sam_model_manager import SAMModelManager
...
setup(
    name="bats-client",
    version="0.2.0",
    description="The client of the Bioimage Annotation Tool for Segmentation for microscopy image segmentation",
    ...
    author_email= ["christina.bukas@helmholtz-munich.de",
                   ...
                   "haider.khan@helmholtz-munich.de",
                   "marie.piraud@helmholtz-munich.de"],
    url="https://github.com/HelmholtzAI-Consultants-Munich/BATS",
    packages=find_packages(),
    include_package_data=True,
    package_data={"bats_client": ["config.yaml", "config_remote.yaml"]},
    install_requires=[
        "matplotlib >=3.3",
        "scikit-image >=0.20",
        "scipy >=1.10", 
    ...
    entry_points={
        "console_scripts": [
            "bats-client=bats_client.main:main",
        ]
    },
    cmdclass={
