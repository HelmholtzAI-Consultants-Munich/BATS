...
from bats_client.gui._custom_qt_helpers import IconProvider, CustomItemDelegate
from bats_client.gui.napari_window import NapariWindow
from bats_client.gui._my_widget import MyWidget
from bats_client.gui._filesystem_wig import MyQFileSystemModel, SegmentationFilterProxyModel

from bats_client.utils import settings
from bats_client.gui.feature_extraction_window import ExtractFeaturesDialog
...
class WorkerThread(QThread):
    ...
    def __init__(
        ...
        :param app: The Application instance. See bats_client.app for more information.
        :type app: bats_client.app.Application
