...
from bats_client.gui.welcome_window import WelcomeWindow
...
from bats_client.utils.utils import read_config
...
def main():
    ...
    setup_logger(log_level=log_level, log_file=os.path.join(os.path.expanduser("~"), ".bats_client", "bats_client.log"))
    
    logger.info("Starting BATS Client...")
